...
from app.controllers.opportunities.repository import OpportunityRepository
...
from app.controllers.opportunities.exceptions import JobOpportunityNotFoundException
