...
from app.controllers.opportunities.dependencies import get_opportunity_service
from app.controllers.opportunities.service import OpportunityService
from app.views.opportunities import (
    JobParseQuery,
    JobOpportunityOut,
    OpportunityCreate,
    OpportunityScoreOut,
