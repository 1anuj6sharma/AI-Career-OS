      ...
      <main className="page-content">
        ...
        <section id="viewIntegrations" className="app-view" style={{ display: "none" }}>
          ...
          <div className="integration-grid" id="integrationCardsGrid">
            ...
            <div className="integration-card" id="cardIntegGitHub">
              <div>
                <div className="integration-card-top">
                  <div className="integration-brand">
                    <div className="integration-icon-box" style={{ "color": "#ffffff", "background": "#24292e" }}>🐙</div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem" }}>GitHub</div>
                      <span style={{ fontSize: "0.76rem", color: "var(--text-muted)" }}>Repositories, Commits & Languages</span>
                    </div>
                  </div>
                  <span className="integration-status-badge disconnected" id="badgeGithubStatus">Not Connected</span>
                </div>
                <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.4 }}>
                  Auto-imports repositories, architectural case studies, top programming languages, and commit telemetry directly into your Project Evidence Graph.
                </p>
                <div className="integration-stats-box" id="statsGithubBox" style={{ display: "none" }}>
                  <div className="integration-stat-unit"><span id="statGithubReposLabel">Public Repos</span><strong id="statGithubReposVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Total Stars</span><strong id="statGithubStarsVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Top Stack</span><strong id="statGithubStackVal">-</strong></div>
                </div>
              </div>
              <div className="integration-actions-row">
                <button className="btn btn-primary btn-sm btn-block btn-open-connect-modal" data-platform="github" id="btnConnectGithub">🔗 Connect GitHub Account</button>
                <button className="btn btn-outline btn-sm btn-sync-platform" data-platform="github" id="btnSyncGithub" style={{ display: "none" }}>🔄 Sync Repos</button>
                <button className="btn btn-outline btn-sm btn-disconnect-platform" data-platform="github" id="btnDisconnectGithub" style={{ "display": "none", "color": "var(--danger)", "borderColor": "rgba(239,68,68,0.3)" }}>Disconnect</button>
              </div>
            </div>

            {/*  2. LINKEDIN INTEGRATION CARD  */}
            <div className="integration-card" id="cardIntegLinkedIn">
              <div>
                <div className="integration-card-top">
                  <div className="integration-brand">
                    <div className="integration-icon-box" style={{ "color": "white", "background": "#0077b5" }}>💼</div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem" }}>LinkedIn</div>
                      <span style={{ fontSize: "0.76rem", color: "var(--text-muted)" }}>Profile, Work History & Network CRM</span>
                    </div>
                  </div>
                  <span className="integration-status-badge disconnected" id="badgeLinkedinStatus">Not Connected</span>
                </div>
                <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.4 }}>
                  Synchronizes verified work experience, alumni networks, and company connections for warm referral routing and automated outreach tailoring.
                </p>
                <div className="integration-stats-box" id="statsLinkedinBox" style={{ display: "none" }}>
                  <div className="integration-stat-unit"><span>Experience</span><strong id="statLinkedinExpVal">0 Roles</strong></div>
                  <div className="integration-stat-unit"><span>Warm Contacts</span><strong id="statLinkedinContactsVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Alumni Paths</span><strong id="statLinkedinAlumniVal">0</strong></div>
                </div>
              </div>
              <div className="integration-actions-row">
                <button className="btn btn-primary btn-sm btn-block btn-open-connect-modal" data-platform="linkedin" id="btnConnectLinkedin">🔗 Connect LinkedIn Profile</button>
                <button className="btn btn-outline btn-sm btn-sync-platform" data-platform="linkedin" id="btnSyncLinkedin" style={{ display: "none" }}>🔄 Sync Network</button>
                <button className="btn btn-outline btn-sm btn-disconnect-platform" data-platform="linkedin" id="btnDisconnectLinkedin" style={{ "display": "none", "color": "var(--danger)", "borderColor": "rgba(239,68,68,0.3)" }}>Disconnect</button>
              </div>
            </div>

            {/*  3. LEETCODE INTEGRATION CARD  */}
            <div className="integration-card" id="cardIntegLeetCode">
              <div>
                <div className="integration-card-top">
                  <div className="integration-brand">
                    <div className="integration-icon-box" style={{ "color": "#ffa116", "background": "#282828" }}>💡</div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem" }}>LeetCode</div>
                      <span style={{ fontSize: "0.76rem", color: "var(--text-muted)" }}>DSA Problem Solving & Contest Rating</span>
                    </div>
                  </div>
                  <span className="integration-status-badge disconnected" id="badgeLeetcodeStatus">Not Connected</span>
                </div>
                <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.4 }}>
                  Feeds problem solving telemetry (Easy/Medium/Hard breakdown, contest rating) straight into your Interview STAR readiness score.
                </p>
                <div className="integration-stats-box" id="statsLeetcodeBox" style={{ display: "none" }}>
                  <div className="integration-stat-unit"><span>Solved Total</span><strong id="statLeetcodeSolvedVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Contest Rating</span><strong id="statLeetcodeRatingVal">Unranked</strong></div>
                  <div className="integration-stat-unit"><span>Top Percentile</span><strong id="statLeetcodePercentileVal">-</strong></div>
                </div>
              </div>
              <div className="integration-actions-row">
                <button className="btn btn-primary btn-sm btn-block btn-open-connect-modal" data-platform="leetcode" id="btnConnectLeetcode">🔗 Connect LeetCode Profile</button>
                <button className="btn btn-outline btn-sm btn-sync-platform" data-platform="leetcode" id="btnSyncLeetcode" style={{ display: "none" }}>🔄 Sync Stats</button>
                <button className="btn btn-outline btn-sm btn-disconnect-platform" data-platform="leetcode" id="btnDisconnectLeetcode" style={{ "display": "none", "color": "var(--danger)", "borderColor": "rgba(239,68,68,0.3)" }}>Disconnect</button>
              </div>
            </div>

            {/*  4. GEEKSFORGEEKS (GFG) INTEGRATION CARD  */}
            <div className="integration-card" id="cardIntegGFG">
              <div>
                <div className="integration-card-top">
                  <div className="integration-brand">
                    <div className="integration-icon-box" style={{ color: "#2f8d46", background: "#e8f5e9" }}>🟢</div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem" }}>GeeksforGeeks (GFG)</div>
                      <span style={{ fontSize: "0.76rem", color: "var(--text-muted)" }}>Coding Score, Practice & Institute Rank</span>
                    </div>
                  </div>
                  <span className="integration-status-badge disconnected" id="badgeGfgStatus">Not Connected</span>
                </div>
                <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.4 }}>
                  Imports GFG practice scores, institution rank, and topic-wise DSA milestones into your verified skill graph.
                </p>
                <div className="integration-stats-box" id="statsGfgBox" style={{ display: "none" }}>
                  <div className="integration-stat-unit"><span>Coding Score</span><strong id="statGfgScoreVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Solved Problems</span><strong id="statGfgSolvedVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Institute Rank</span><strong id="statGfgRankVal">-</strong></div>
                </div>
              </div>
              <div className="integration-actions-row">
                <button className="btn btn-primary btn-sm btn-block btn-open-connect-modal" data-platform="gfg" id="btnConnectGfg">🔗 Connect GeeksforGeeks</button>
                <button className="btn btn-outline btn-sm btn-sync-platform" data-platform="gfg" id="btnSyncGfg" style={{ display: "none" }}>🔄 Sync Score</button>
                <button className="btn btn-outline btn-sm" id="btnOpenGfg" style={{ display: "none" }}>Open Profile</button>
                <button className="btn btn-outline btn-sm btn-disconnect-platform" data-platform="gfg" id="btnDisconnectGfg" style={{ "display": "none", "color": "var(--danger)", "borderColor": "rgba(239,68,68,0.3)" }}>Disconnect</button>
              </div>
            </div>

            {/*  5. JOB MAILBOX & EMAIL TRACKER (GMAIL / OUTLOOK)  */}
            <div className="integration-card" id="cardIntegEmail">
              <div>
                <div className="integration-card-top">
                  <div className="integration-brand">
                    <div className="integration-icon-box" style={{ "color": "#ea4335", "background": "#fce8e6" }}>📬</div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem" }}>Job Mailbox (Email Sync)</div>
                      <span style={{ fontSize: "0.76rem", color: "var(--text-muted)" }}>Gmail, Outlook & Recruiter Inboxes</span>
                    </div>
                  </div>
                  <span className="integration-status-badge disconnected" id="badgeEmailStatus">Not Connected</span>
                </div>
                <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.4 }}>
                  Automates application lifecycle tracking by scanning for ATS confirmations, interview invitations, and recruiter responses to update Kanban columns.
                </p>
                <div className="integration-stats-box" id="statsEmailBox" style={{ display: "none" }}>
                  <div className="integration-stat-unit"><span>Active Inboxes</span><strong id="statEmailInboxesVal">1</strong></div>
                  <div className="integration-stat-unit"><span>Auto-Logged Apps</span><strong id="statEmailAppsVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Interview Invites</span><strong id="statEmailInvitesVal">0</strong></div>
                </div>
              </div>
              <div className="integration-actions-row">
                <button className="btn btn-primary btn-sm btn-block btn-open-connect-modal" data-platform="email" id="btnConnectEmail">🔗 Connect Job Application Email</button>
                <button className="btn btn-outline btn-sm btn-sync-platform" data-platform="email" id="btnSyncEmail" style={{ display: "none" }}>⚡ Scan Inboxes</button>
                <button className="btn btn-outline btn-sm btn-disconnect-platform" data-platform="email" id="btnDisconnectEmail" style={{ "display": "none", "color": "var(--danger)", "borderColor": "rgba(239,68,68,0.3)" }}>Disconnect</button>
              </div>
            </div>

            {/*  6. KAGGLE & HUGGING FACE (AI / ML)  */}
            <div className="integration-card" id="cardIntegKaggle">
              <div>
                <div className="integration-card-top">
                  <div className="integration-brand">
                    <div className="integration-icon-box" style={{ "color": "#20beff", "background": "#e1f5fe" }}>🤗</div>
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.95rem" }}>Kaggle & Hugging Face</div>
                      <span style={{ fontSize: "0.76rem", color: "var(--text-muted)" }}>ML Models, Datasets & Competitions</span>
                    </div>
                  </div>
                  <span className="integration-status-badge disconnected" id="badgeKaggleStatus">Not Connected</span>
                </div>
                <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", lineHeight: 1.4 }}>
                  Showcase machine learning models, open-source weights, dataset contributions, and competition medals.
                </p>
                <div className="integration-stats-box" id="statsKaggleBox" style={{ display: "none" }}>
                  <div className="integration-stat-unit"><span>Notebooks</span><strong id="statKaggleNotebooksVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Models Hosted</span><strong id="statKaggleModelsVal">0</strong></div>
                  <div className="integration-stat-unit"><span>Medals</span><strong id="statKaggleMedalsVal">0</strong></div>
                </div>
              </div>
              <div className="integration-actions-row">
                <button className="btn btn-primary btn-sm btn-block btn-open-connect-modal" data-platform="kaggle" id="btnConnectKaggle">🔗 Connect AI Portfolio</button>
                <button className="btn btn-outline btn-sm btn-sync-platform" data-platform="kaggle" id="btnSyncKaggle" style={{ display: "none" }}>🔄 Sync Models</button>
                <button className="btn btn-outline btn-sm btn-disconnect-platform" data-platform="kaggle" id="btnDisconnectKaggle" style={{ "display": "none", "color": "var(--danger)", "borderColor": "rgba(239,68,68,0.3)" }}>Disconnect</button>
              </div>
            </div>
